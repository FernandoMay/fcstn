...
public class FCSTNClient : MonoBehaviour
{
    ...
    private Color baseColor = new Color(0.1f, 0.4f, 1.0f);
    private Color transitionalColor = new Color(0.6f, 0.1f, 0.9f);
    private Color criticalColor = new Color(1.0f, 0.1f, 0.1f);
